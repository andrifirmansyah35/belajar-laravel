...
<div class="row justify-content-center">
    ...
    @if ($posts->count())
        <div class="card mb-3">
            @if ($posts[0]->image)
            <img src="{{ asset('storage/'.$posts[0]->image) }}" class="img-fluid mt-5"
            alt="{{ $posts[0]->category->name }}" style="overflow:hidden; max-height:350px;">
            @else
            ...
            <div class="card-body">
                ...
                <p><small>
                        By
                        <a href="/posts/?author={{ $posts[0]->author->name }}">{{ $posts[0]->author->name }}</a>
                        in
            ...
            @endif
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            <small>
                                By 
                                <a href="/posts/?author={{ $post->author->name }}">{{ $post->author->name }}</a> in
